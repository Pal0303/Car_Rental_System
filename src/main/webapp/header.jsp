        ...
        <div class="row">
            ...
            <div class="col-md-6 text-center text-lg-right">
                <div class="d-inline-flex align-items-center">
                    ...
                    <% if(u==null){
                    %>
            <a class="text-body px-3" href="login.jsp"><i class="fa fa-sign-in-alt mr-2"></i>Login</a>
            <a class="text-body px-3" href="signup.jsp"><i class="fa fa-user-plus mr-2"></i>Signup</a>
